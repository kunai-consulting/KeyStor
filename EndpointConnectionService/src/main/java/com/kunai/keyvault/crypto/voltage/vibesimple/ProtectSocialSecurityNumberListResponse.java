...
@XmlRootElement(name = "ProtectSocialSecurityNumberListResponse")
public class ProtectSocialSecurityNumberListResponse {
     ...
     * {@link String }
     * 
     * @return a List of String for data output.
     */
