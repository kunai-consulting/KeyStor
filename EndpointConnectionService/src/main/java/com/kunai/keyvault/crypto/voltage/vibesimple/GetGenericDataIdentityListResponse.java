...
@XmlRootElement(name = "GetGenericDataIdentityListResponse")
public class GetGenericDataIdentityListResponse {
     ...
     * {@link String }
     * 
     * @return list of strings that represent an identity of a person.
     */
