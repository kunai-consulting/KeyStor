 ...
 *         {@literal <}element name="dataIn" type="{http://voltage.com/vibesimple}DataRange" maxOccurs="unbounded"/{@literal >}
...
@XmlRootElement(name = "AccessFormattedDataRangeList")
public class AccessFormattedDataRangeList {
