...
@XmlRootElement(name = "ProtectFormattedDataListMultiplexed")
public class ProtectFormattedDataListMultiplexed {
     ...
     * {@link String }
     * 
     * @return an ArrayList of String that represent the input data.
     */
