 ...
 *         {@literal <}element name="creditCardNumber" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded"/{@literal >}
...
@XmlRootElement(name = "ProtectCreditCardNumberListV2")
public class ProtectCreditCardNumberListV2 {
     ...
     * {@link String }
     * 
     * @return a List a list of Strings that represent a credit card number.
     */
