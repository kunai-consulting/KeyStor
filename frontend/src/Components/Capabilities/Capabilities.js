    ...
    <div className={rowClass}>
      <div className={colClass}>
        <div className="capabilities__paper">
          ...
          <div className={`${rowClass} capabilities__paper__bullets`}>
            <div className={twoColClass}>
              <StyledBullet className="capabilities__paper__bullet">Use an open source solution like <a href="https://github.com/kunai-consulting/KeyStor" target="__blank">KeyStor</a>.</StyledBullet>
            </div>
            <div className={twoColClass}>
