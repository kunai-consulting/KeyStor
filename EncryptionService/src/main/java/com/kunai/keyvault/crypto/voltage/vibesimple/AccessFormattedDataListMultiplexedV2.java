...
@XmlRootElement(name = "AccessFormattedDataListMultiplexedV2")
public class AccessFormattedDataListMultiplexedV2 {
     ...
     * {@link String }
     * 
     * @return an Array List containing the entered data.
     */
     ...
     *
     * @return if the property is masked or not.
     */
     ...
     *
     * @param value if the property is masked or not.
     */
