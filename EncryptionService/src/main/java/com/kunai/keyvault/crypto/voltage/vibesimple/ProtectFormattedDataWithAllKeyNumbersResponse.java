...
@XmlRootElement(name = "ProtectFormattedDataWithAllKeyNumbersResponse")
public class ProtectFormattedDataWithAllKeyNumbersResponse {
     ...
     * {@link String }
     * 
     * @return an array list of strings for output.
     */
