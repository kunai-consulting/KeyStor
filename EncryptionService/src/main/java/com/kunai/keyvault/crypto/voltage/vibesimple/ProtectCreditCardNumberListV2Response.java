...
@XmlRootElement(name = "ProtectCreditCardNumberListV2Response")
public class ProtectCreditCardNumberListV2Response {
     ...
     * {@link String }
     * 
     * @return a list of Strings that represents the output data
     */
