...
@XmlRootElement(name = "AccessFormattedDataMultiplexedV2")
public class AccessFormattedDataMultiplexedV2 {
     ...
     *
     * @return if the property is masked ot not.
     */
     ...
     * @param value sets the value if it is masked or not.
     */
