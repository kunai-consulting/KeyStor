...
@XmlRootElement(name = "AccessSocialSecurityNumberListResponse")
public class AccessSocialSecurityNumberListResponse {
     ...
     * {@link String }
     * 
     * @return an output array list of strings that represents SSN.
     */
