...
@XmlRootElement(name = "ProtectCreditCardNumberListResponse")
public class ProtectCreditCardNumberListResponse {
     ...
     * {@link String }
     * 
     * @return An array list of strings representing the output data.
     */
