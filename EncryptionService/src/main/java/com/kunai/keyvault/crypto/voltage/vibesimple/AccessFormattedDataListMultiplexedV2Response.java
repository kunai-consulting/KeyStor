...
@XmlRootElement(name = "AccessFormattedDataListMultiplexedV2Response")
public class AccessFormattedDataListMultiplexedV2Response {
     ...
     * {@link String }
     * 
     * @return an Array List representing the processed data.
     */
